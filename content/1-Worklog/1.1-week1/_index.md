...
| 5   | - Hands-on practice: <br> + Launch an EC2 instance <br> + Create a simple Lambda function <br> + Configure AWS Budget <br> + Deploy a basic RDS (Aurora) instance | 08/15/2025 | 08/15/2025 | [AWS Docs](https://docs.aws.amazon.com/) |


---

## Week 1 Achievements:
- Successfully created an AWS account and received **100$ credit**.  
- Practiced with key AWS services: **EC2, Bedrock, Lambda, Budget, Aurora/RDS**.  
- Completed **Module 1 of AWS Study Group** on YouTube.  
...
- Built a strong foundation to continue with the next modules.  
